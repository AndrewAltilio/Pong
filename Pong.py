...
def main():
    ...
    while True:
        ...
        #Movement keys for the left (w,s) paddle and right (up arrow, down arrow) paddle.
        ...
        if b1['rect'].bottom > WINDOWHEIGHT:
            ...
            if b1['dir'] == DOWNRIGHT:
                b1['dir'] = UPRIGHT
        #If player hits top or bottom of the screen, paddle stops.
        if P1.top < 0:
            P1
        ...
        #Direction for the ball off the serve.
        upOrDown = random.randint(1,2)
        if P1.colliderect(b1['rect']) and b1['dir'] == LEFT:
            hitSound.play()
            if upOrDown == 1:
                b1['dir'] = UPRIGHT
            if upOrDown == 2:
        ...
        if P2.colliderect(b1['rect']) and b1['dir'] == RIGHT:
            hitSound.play()
            if upOrDown == 1:
                b1['dir'] = UPLEFT
            if upOrDown == 2:
